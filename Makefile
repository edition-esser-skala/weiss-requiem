...
project = Weiss_Requiem_in_Es
notes = cl1 cl2 cor1 cor2 clno1 clno2 vl1 vl2 S A T B org vlne
scores = full_score cl1 cl2 ottoni vl1 vl2 coro b org org_realized
